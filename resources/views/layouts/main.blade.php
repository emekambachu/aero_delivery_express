...
<head>
    ...
    <title>@yield('title') - Aero Delivery Express</title>
    <!-- favicon -->
    <link rel=icon href={{ asset('aero_delivery_favicon.png') }} sizes="20x20" type="image/png">
    <!-- animate -->
                    ...
                    <div class="topbar-inner">
                        <div class="left-contnet">
                            <ul class="info-items">
                                ...
                                <li><a href="mailto:info@aerodeliveryexpress.com"><i class="flaticon-mail"></i> info@aerodeliveryexpress.com</a></li>
            ...
            <div class="responsive-mobile-menu">
                <div class="logo-wrapper">
                    <a href="{{ url('/') }}" class="logo">
                        <img src="{{ asset('aero_delivery_logo2.png') }}" width="300" alt="">
                    </a>
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget widget">
                        <div class="about_us_widget">
                            <a href="{{ url('/') }}" class="footer-logo"> <img src="{{ asset('aero_delivery_logo2.png') }}" alt="footer logo"></a>
