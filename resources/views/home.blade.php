                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="header-inner">
                            <!-- header inner -->
                            <h1 class="title">Aero Delivery Express</h1>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="single-header-bottom-item white">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>Aero Delivery Express Port is the most efficient port in the region, with a sub-3 hour turnaround.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-12">
                            ...
                            <div class="col-md-6 col-lg-12">
                                <div class="single-header-bottom-item white">
                                    ...
                                    <div class="content">
                                        ...
                                        <p>Aero Delivery Express Port offers the fastest customs clearance of any country in the GCC.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="section-title b-top desktop-center padding-top-25 margin-bottom-55">
                        ...
                        <p>Aero Delivery Express is the logistics and transportation hub of the Southeast and your direct access to the world. With an extensive line-up of distribution and warehousing facilities, world-class supply chain infrastructure, and the nation’s fastest-growing port, Aero Delivery Express is ready to move your product efficiently and seamlessly.
                        </p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="single-what-we-provide-item margin-bottom-30">
                        ...
                        <div class="content-wrapper">
                            ...
                            <div class="content">
                                ...
                                <p>Aero Delivery Express partners with airlines and freight forwarders to offer seamless air freight solutions to clients globally. We offer a competitive and quick service which includes our air express, high priority (24 hours) delivery.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="we-offer-content">
                        <div class="content">
                            <div class="section-title">
                                ...
                                <p>If your 3PL or distribution center is seeking to grow, Aero Delivery Express is the place to be. When you choose Aero Delivery Express, you are choosing a solid foundation of air, land and sea transportation that will enhance your business growth and keep you competitive in the global marketplace.</p>
                            </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-sm-11 col-11">
                        <div class="section-title white b-top desktop-center padding-top-25 margin-bottom-55">
                            <h2 class="title">Why choose Aero Delivery Express</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
